...
class IngredientModel extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, namePlural, unit', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, namePlural, unit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nameSingular',$this->nameSingular,true);
		$criteria->compare('namePlural',$this->namePlural,true);
